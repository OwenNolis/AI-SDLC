...
![Checkout en order summary](feature-011-preworkout-website/page-3-1.png)
...
Onderstaande contracten geven een concrete basis voor backend implementatie. Alle endpoints onder /admin vereisen een rol Admin. Klantgebonden endpoints vereisen een geldige JWT token.
...
| POST /api/cart/items | JWT token, productid, quantity | 201: cart item; 400: quantity onvolgende; 409: onvoldoende voorraad |
...
| POST /api/orders | JWT token, shippingAddress, paymentMethod | 201: order Pending + paymentUrl; 400: leeg winkelmandje; 409: voorraadprobleem |
...
* AC-004-2: Gegeven betaling mislukt, wanneer provider weigert, dan blijft order Pending of wordt Order Cancelled.
